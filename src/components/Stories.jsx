...
const storie = [
    ...
    { name: "nathanwpylestrangeplanet", image: "assets/img/nathanwpylestrangeplanet.svg", fundo: "assets/img/stories_background.jpg" },
    { name: "wawawicomics", image: "assets/img/wawawicomics.svg", fundo: "assets/img/stories_background.jpg" },
    ...
    { name: "memeriagourmet", image: "assets/img/memeriagourmet.svg", fundo: "assets/img/stories_background.jpg" },
]
